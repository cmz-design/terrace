TARGETS=graph_bm_weighted graph_bm graph_bm_dev graph_bm_static graph_bm_no_update test_graphcontainer test_btree test_pma test_adj test_powlaw test_test
...
graph_bm_dev:								$(OBJDIR)/graph_bm_dev.o \
												$(OBJDIR)/util.o \
												$(OBJDIR)/PMA.o $(OBJDIR)/PMA_Lock.o \
												$(OBJDIR)/partitioned_counter.o

graph_bm_static:								$(OBJDIR)/graph_bm_static.o \
												$(OBJDIR)/util.o \
												$(OBJDIR)/PMA.o $(OBJDIR)/PMA_Lock.o \
												$(OBJDIR)/partitioned_counter.o
...
$(OBJDIR)/graph_bm_static.o: 						$(LOC_SRC)/graph_bm_static.cc \
																	$(LOC_INCLUDE)/graph.h \
																	$(LOC_INCLUDE)/util.h \
																	$(LOC_INCLUDE)/PMA.hpp \
																	$(LOC_INCLUDE)/partitioned_counter.h
...
$(OBJDIR)/graph_bm_dev.o: 						$(LOC_SRC)/graph_bm_dev.cc \
																	$(LOC_INCLUDE)/graph.h \
																	$(LOC_INCLUDE)/util.h \
																	$(LOC_INCLUDE)/PMA.hpp \
																	$(LOC_INCLUDE)/BlockQueue.h \
																	$(LOC_INCLUDE)/partitioned_counter.h
